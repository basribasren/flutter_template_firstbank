...
class AppNavigationScreen extends StatelessWidget {
                                ...
                                child: Container(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          GestureDetector(
                                              onTap: () {
                                                onTapSettingPreferenceTabContainer(
                                                    context);
                                              },
                                              child: Container(
                                                  decoration: AppDecoration
  ...
  onTapTransactionsTabContainer(BuildContext context) {
    NavigatorService.pushNamed(
  ...
  onTapInvestments(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.investmentsScreen,
    );
  }

  onTapCreditCards(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.creditCardsScreen,
    );
  }

  onTapLoans(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.loansScreen,
    );
  }

  onTapServices(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.servicesScreen,
    );
  }

  onTapSettingPreferenceTabContainer(BuildContext context) {
    NavigatorService.pushNamed(
