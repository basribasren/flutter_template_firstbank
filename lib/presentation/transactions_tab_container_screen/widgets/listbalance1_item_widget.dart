...
class Listbalance1ItemWidget extends StatelessWidget {
  Listbalance1ItemWidget(this.listbalance1ItemModelObj);

  Listbalance1ItemModel listbalance1ItemModelObj;
