...
class AccountsScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<AccountsBloc>(
        create: (context) =>
            AccountsBloc(AccountsState(accountsModelObj: AccountsModel()))
                        ...
                        child: Column(
                            ...
                            children: [
                              Padding(
                                  ...
                                  child: BlocSelector<AccountsBloc,
                                          AccountsState, AccountsModel?>(
                                      selector: (state) =>
                                          state.accountsModelObj,
                                      builder: (context, accountsModelObj) {
                                        return GridView.builder(
                                            ...
                                            itemCount: accountsModelObj
                                                    ?.accountsItemList.length ??
                                                0,
                                            itemBuilder: (context, index) {
                                              AccountsItemModel model =
                                                  accountsModelObj
                                                              ?.accountsItemList[
                                                          index] ??
                                                      AccountsItemModel();
                                      ...
                                      builder: (context, accountsModelObj) {
                                        return ListView.separated(
                                            ...
                                            itemCount: accountsModelObj
                                                ...
                                                0,
                                            itemBuilder: (context, index) {
                                              ListrefreshItemModel model =
                                                  accountsModelObj
                                                              ?.listrefreshItemList[
                                                          index] ??
                                                      ListrefreshItemModel();
